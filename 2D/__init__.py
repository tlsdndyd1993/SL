...
class PINMAP_CHECKER_REV0:
    def __init__(self):
        ...
        self.spl_wiring(self.cc_d_attribute_set_dict, self.all_length_dict, self.spl_dic, self.data_rev05, self.marking, self.column_rev02, self.row_rev02)
...
################################################################################################################################################################################################
    ...
    def specify_wiring_type(self,cc_d_attribute_set_dict): 
        ...
        if len(wiring_type) != wire_type_num:
            ...
            self.specify_wiring_type(self.cc_d_attribute_set_dict)
    ...
    def specify_wiring_length(self,cc_d_attribute_set_dict):
        ...
        if len(wiring_length) != wire_length_num:
            ...
            self.specify_wiring_length(self.cc_d_attribute_set_dict)
        length_dict_num = 0
        length_list = []
        all_length_list = []
        for ii in cc_d_attribute_set_dict.keys():
