...
class PathSettingsPanel(QWidget):
    ...
    def _build(self):
        ...
        self.tc_mode_range.toggled.connect(
            lambda c: (self.tc_mode_single.blockSignals(True),
                       self.tc_mode_single.setChecked(not c),
                       self.tc_mode_single.blockSignals(False),
                       self._upd_tc_id()))
        ...
        num_grid.addWidget(QLabel("시작 번호"), 0, 0)
        self.tc_start_spin = QSpinBox()
        self.tc_start_spin.setRange(0, 99999); self.tc_start_spin.setValue(1)
        self.tc_start_spin.setFixedWidth(78)
        self.tc_start_spin.setStyleSheet(
            "QSpinBox{background:#1a1a3a;color:#f0c040;border:1px solid #4a4a20;"
            "border-radius:3px;padding:3px;font-size:12px;font-weight:bold;}")
        ...
        num_grid.addWidget(self._tc_end_lbl, 0, 2)
        self.tc_end_spin = QSpinBox()
        self.tc_end_spin.setRange(0, 99999); self.tc_end_spin.setValue(50)
        self.tc_end_spin.setFixedWidth(78)
        self.tc_end_spin.setStyleSheet(
            "QSpinBox{background:#1a1a3a;color:#f0c040;border:1px solid #4a4a20;"
            "border-radius:3px;padding:3px;font-size:12px;font-weight:bold;}")
        self.tc_end_spin.valueChanged.connect(self._upd_tc_id)
        num_grid.addWidget(self.tc_end_spin, 0, 3)

        num_grid.addWidget(QLabel("자릿수"), 1, 0)
        ...
        num_grid.addWidget(self.tc_digits_spin, 1, 1)
        ...
        # 초기 모드 적용 (개별 기본)
        self._tc_end_lbl.setVisible(False)
        self.tc_end_spin.setVisible(False)
    ...
    def _on_tc_mode_changed(self, single: bool):
        ...
        # 범위 모드일 때만 끝 번호 표시
        self._tc_end_lbl.setVisible(is_range)
        self.tc_end_spin.setVisible(is_range)
        self._upd_tc_id()
